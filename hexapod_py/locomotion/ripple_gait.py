...
class RippleGait(Gait):
    ...
    def run(self, vx, vy, omega, roll, pitch, speed, default_foot_positions, last_known_angles, body_height, step_height, rotation_scale_factor=1.0):
        ...
        for i, leg_idx in enumerate(self.ripple_sequence):
            ...
            joint_angles[leg_idx] = self._calculate_leg_ik(leg_idx, phase, vx, vy, omega, roll, pitch, default_foot_positions, last_known_angles, self.max_step_length, body_height, step_height, rotation_scale_factor)
        return joint_angles
