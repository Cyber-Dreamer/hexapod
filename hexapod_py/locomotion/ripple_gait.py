...
class RippleGait(Gait):
    def __init__(self, kinematics, step_height, step_length, knee_direction):
        ...
        self.ripple_sequence = [2, 1, 0, 3, 5, 4] # FR, FL, MR, ML, RR, RL
    ...
    def run(self, vx, vy, omega, pitch, speed, default_foot_positions, body_height, step_height):
        ...
        for i, leg_idx in enumerate(self.ripple_sequence):
            ...
            joint_angles[leg_idx] = self._calculate_leg_ik(leg_idx, phase, vx, vy, omega, pitch, default_foot_positions, self.step_length, body_height, step_height)
        return joint_angles
