...
class RippleGait(Gait):
    ...
    def run(self, vx, vy, omega, roll, pitch, speed, default_foot_positions, default_joint_angles, body_height, step_height, max_step_length):
        ...
        for i, leg_idx in enumerate(self.ripple_sequence):
            ...
            joint_angles[leg_idx] = self._calculate_leg_ik(leg_idx, phase, vx, vy, omega, roll, pitch, default_foot_positions, default_joint_angles, max_step_length, body_height, step_height)
        return joint_angles
